        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            else
            {
                ...
                if(UserName.equals("Admin") && (UserPassword.equals("jitu")))
                {
                    Admin adm = new Admin(UserName,UserPassword);
                    HttpSession sess = request.getSession();
                    sess.setAttribute("Administrator", adm);
                ...
                else
                {
                    ...
                    User user = dao.getUser(UserName ,UserPassword);
